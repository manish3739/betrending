...
import { Alert, StyleSheet, Text, TouchableOpacity, View, ViewProps } from 'react-native';
import {
  PanGestureHandler,
...
function handleCamerCount() {
  ...
  const onHandlerStateChanged = useCallback(
    ...
    [isPressingButton, recordingProgress, setIsPressingButton, startRecording, stopRecording],
  );
  //#endregion
  //#region Pan handler
  ...
  return (
    <>
    {/* <View style={{flexDirection:'row',justifyContent:'space-between',width:'100%',top:40}}>
      <TouchableOpacity onPress={() => stopRecording()}>
        <Text style={{ color: 'red' }}>stop</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => pauseRecording()}>
        <Text style={{ color: 'yellow' }}>pause</Text>
      </TouchableOpacity>
